...
export default function KingsClubDashboard() {
  ...
  <header className="items-center justify-between hidden p-6 md:flex">
        <div className="flex items-center gap-4">
          <div className="text-2xl font-bold tracking-wider text-black" >Hello Student</div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {filteredCourses.length === 0 && (
              <div className="col-span-3 py-8 text-center text-gray-500">No courses found.</div>
            )}
